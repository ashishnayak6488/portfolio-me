...
const {getPortfolioData , updateIntro , updateAbout , addProject, updateProject, deleteProject , updateContact, adminLogin, addEducation, updateEducation, deleteEducation} = require('../controllers/portfolioController');
